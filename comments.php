...
/*     This is comment.phps by Christian Montoya, http://www.christianmontoya.com
    ...
    Use of this code does not grant you the right to use the design or any of 
		the other files on my site. Beyond this file, all rights are reserved, 
 ...
 */ ?>
    ...
    <h4 id="comments-header">Leave a comment</h4>
    ...
    <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" class="form-inline">
    ...
    <?php else : ?>
        ...
        <p>
          ...
          <input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22" title="Name as it will appear on the comment."/>
        </p>

        <p>
          <label for="email">E-mail</label>
          <input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" title="E-mail address (required)."/>
        </p>

        <p>
          <label for="url">Website</label>
          <input type="text" name="url" id="url" value="<?php echo $comment_author_url; ?>" size="22" title="Your web site (optional)."/>
        </p>
    ...
    <?php /* You might want to display this:
        ...
        <p><textarea name="comment" id="comment" rows="5" cols="30" title="Your comment."></textarea></p>
        ...
        <?php /* Buttons are easier to style than input[type=submit],
                ...
                if you like */
        ?>
        <p><button type="submit" name="submit" id="sub" class="btn">Post Comment</button>
